...
task autonomous()
{
  ...
  AutoBaseInit_Chassis(s_LeftEn, s_RightEn, 12.57, 14.32, 20, 400);

  AutoBaseInit_Config(baseDrive, 20, 90, 70, 120, 0.6, 0, 2); //turning 70
  AutoBaseInit_Config(baseTurn, 20, 50, 70, 150, 0.6, 0, 2);
  AutoBaseInit_Config(baseAllign, 20, 40, 70, 150, 0.6, 0, 2);
